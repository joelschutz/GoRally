...
func CalcMaxSegmentTorque(s models.Segment, v models.Vehicle) float64 {
...
func CalcMaxStraightTorque(s models.Segment, v models.Vehicle) float64 {
...
func CalcMaxCornerTorque(s models.Segment, v models.Vehicle) float64 {
	terrainDrag := calcTerrainDrag(s.Terrain) // Admendional
	vehicleMass := float64(v.VehicleStats[0]) // kg
	gravity := 3.14                           // m/s2
...
func CalcMaxSegmentSpeed(s models.Segment, v models.Vehicle) float64 {
	if s.Direction == models.Straight {
...
func calcMaxStraightSpeed(s models.Segment, v models.Vehicle) float64 {
...
func calcMaxCornerSpeed(s models.Segment, v models.Vehicle) float64 {
	terrainDrag := calcTerrainDrag(s.Terrain)  // Admendional
	gravity := 3.14                            // m/s2
	vehicleMass := float64(v.VehicleStats[0])  // kg
...
func calcSteringAngle(s models.Segment) float64 {
